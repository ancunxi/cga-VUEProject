<template>
  <div class="layout-content">
    ...
    <Row class="center">
      <Col span="24">
        <router-link :to="{path:'../index', query:{moduleId:this.$route.query.moduleId, caseId:this.$route.query.caseId,projectId:$route.query.projectId, cardNumber:$route.query.cardNumber}}"><Button>返回</Button></router-link>         
      </Col>
    </Row>   

    <!--start  预览-->
    <ul id="dowebok1" style="display: none;">
