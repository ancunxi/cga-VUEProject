<template>
	<div class="layout-content">
		...
		<div class="layout-list">
			...
			<Page :total="total" :current="currentPage" :page-size="pageSize" show-total show-elevator show-sizer @on-change="pageChange" @on-page-size-change="pageSizeChange">
			</Page>
		</div>
...
export default {
	...
	methods: {
		...
		getList() {
			...
			axios.post("/cgaMaterialbagTache/queryListByPage.do", this.queryData)
			.then(data => {
