<template>
  <Row>
    <Col span="24">
          ...
          <iframe class="sreportFramesCheck" width="100%" height="100%" style='border:none;' :src='this.fileReproUrls+"/ReportServer?reportlet="+cptUrl+"&op=write&__showtoolbar__=false&caseId="+this.$route.query.caseId'></iframe>
