<template>
  <div class="layout-content">
    ...
    <!--start  预览-->
    <ul id="dowebok24" style="display: none;">
...
export default {
  ...
  created(){
    ...
    //查询意见处理区 流程环节信息
    axios.post("/cgaCase/queryNetCaseInfoByCaseId.do", {caseId:this.$route.query.caseId,moduleName:'网上办理'})
    .then(data=>{
  ...
  methods:{
    ...
    previews(id,type){
      ...
      if(type != '.png' && type != '.jpg' && type != '.bmp'){
        ...
        var viewer = new Viewer(document.getElementById('dowebok24'), {
          url: 'data-original'
        });
        setTimeout(()=>{
          $('#dowebok24 img').click();
