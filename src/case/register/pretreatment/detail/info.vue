    ...
    <Row class="margin-bottom-20">
      <Col span="24">
        ...
        <Row>
          ...
          <Col span="12" v-if="$route.query.yuShenType=='1'">
    ...
    <Row v-if="projectData.applyObjectType=='0'" class="margin-bottom-20">
      <Col span="24">
        ...
        <Row>
          <Col span="8">
            <FormItem label="姓名：">
              {{userData.relatedPersonName}}<Icon v-if="this.userData.applyFileId!=undefined && this.userData.applyFileId!=''" type="person" title="点击查看头像" @click.native="viewIcon"></Icon>
            </FormItem>
          </Col>                   
          <Col span="8">
