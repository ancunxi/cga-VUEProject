  ...
  <div class="layout-content">
    ...
    <div class="tabs">
      <Tabs type="card">
        ...
        <TabPane label="资料袋" name="tab2">
          <tab2-view  :isShowData="isShowData"></tab2-view>
        </TabPane>
        ...
        <template v-if="tabFormLoad">
          ...
          <TabPane :label="tab9Name">
            <tab9-view ref="tab9view"></tab9-view>
          </TabPane>          
          <TabPane :label="tab8Name">
            <tab8-view ref="tab8view"></tab8-view>
          </TabPane>
          <TabPane :label="tab7Name">
            <tab7-view ref="tab7view"></tab7-view>
          </TabPane>   
        </template>      
      </Tabs> 
    </div>
    ...
    <!--start  预览-->
    <ul id="dowebok27" style="display: none;">
...
import opinion from './opinionPretrial.vue';  //意见处理框
export default {
  components: {
    'panel-view': panel,    
    'tab1-view': tab1,
   ...
   //预览
    previews(id,type){
      ...
      if(type != '.png' && type != '.jpg' && type != '.bmp'){
        ...
        var viewer = new Viewer(document.getElementById('dowebok27'), {
          url: 'data-original'
        });
        setTimeout(()=>{
          $('#dowebok27 img').click();
