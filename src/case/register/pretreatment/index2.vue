	...
	<div class="layout-content">
		<div class="layout-inquiry">
			<div class="layout-tabs">
				<router-link :to="{path:'index',query:{moduleId:this.$route.query.moduleId}}">待预审</router-link>
				<a href="javascript:;" class="active2">已预审</a>
			</div>
			<Form>
				<Row :gutter="16">
					<Col :lg="6" :xs="12">
	...
	export default {
		...
		methods: {
			getList() {
				...
				axios.post("/cgaCaseRegist/queryCgaNetPassCaseByPage.do", Object.assign({
					caseState: '20',
					caseId: this.caseId,
