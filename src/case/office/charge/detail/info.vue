    ...
    <Row class="margin-bottom-20">
      <Col span="24">
        ...
        <Row>
          <Col span="8">
            <FormItem label="姓名：">
              {{relatedPersonInfo.relatedPersonName}}<Icon type="person" v-if="this.relatedPersonInfo.applyFileId!=undefined && this.relatedPersonInfo.applyFileId!=''" title="点击查看头像" @click.native="viewIcon"></Icon>
            </FormItem>
          </Col>                   
          <Col span="8">
...
export default {
  ...
  data () {
    return { 
      ...
      one: '',
      formValidate:{
        two: '1.2017-09-07 15:26:40 缴费 20.0元',
        three: '1.2017-09-07 15:26:29 退费 10.0元' 
      },
      caseInfo:{},  //办件详情  
