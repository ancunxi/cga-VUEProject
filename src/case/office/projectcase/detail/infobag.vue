              ...
              <template v-for="item in materialData">
                <Col span="4" class="margin-bottom-40 h140">
                  <div class="plate">
                    ...
                    <div>
                      <router-link :to="{path:'./application/sample', query:{materialId:item.materialId, id:$route.query.id, caseId:$route.query.caseId, projectId:$route.query.projectId, moduleId:$route.query.moduleId,cardNumber:$route.query.cardNumber,applySourceName:$route.query.applySourceName,tabsName:tabsName}}" v-if="item.exampleNum > '0'"><Button type="info" size="small">样例</Button></router-link>
                      <router-link :to="{path:'./application/view', query:{materialId:item.materialId, id:$route.query.id, caseId:$route.query.caseId, projectId:$route.query.projectId, moduleId:$route.query.moduleId,cardNumber:$route.query.cardNumber,applySourceName:$route.query.applySourceName,tabsName:tabsName}}" v-if="item.uploadNum > '0'"><Button type="success" size="small">查看</Button></router-link>
                    </div>
                  </div>
                </Col>
              </template>
