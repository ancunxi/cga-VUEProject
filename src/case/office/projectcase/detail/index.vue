  ...
  <div class="layout-content">
    ...
    <div class="tabs">
      <Tabs type="card" v-model="tabsName" @on-click="changeTabs">
        ...
        <TabPane label="资料袋" name="资料袋"  v-if="$route.query.applySourceName=='false'">
          <tab3-view 
            :isShowData="isShowData"
            @previewsFun="previews"
            :tabsName="tabsName">
        ...
        <!--业务表单-->
        <template v-for="(item, index) in tabFormData"  v-if="$route.query.applySourceName=='false'">
        ...
        <template v-if="tabFormLoad">
          <TabPane :label="tab6Name" name="tab6"  v-if="$route.query.applySourceName=='false'">
            <tab6-view showFlag="'1'" ref="component4"></tab6-view>
          </TabPane>    
          <!-- 办件历程 -->
          <TabPane :label="tab7Name" name="tab7"  v-if="$route.query.applySourceName=='false'">
            <tab7-view showFlag="'1'" ref="tab7view"></tab7-view>
          </TabPane>        
                              
          <!--右侧公共部分-->
          <TabPane :label="tab10Name" name="tab10"  v-if="$route.query.applySourceName=='false'">
            <rightTab1-view showFlag="'1'" ref="tab10view" @previewsFun="previews"></rightTab1-view>
          </TabPane>
          <TabPane :label="tabName3" name="tab3"  v-if="$route.query.applySourceName=='false'">
            <rightTab2-view showFlag="'1'" ref="component3"></rightTab2-view>
          </TabPane>          
          <TabPane :label="tabName2" name="tab2"  v-if="$route.query.applySourceName=='false'">
            <rightTab3-view showFlag="'1'" ref="component2"></rightTab3-view>
          </TabPane>
          <TabPane :label="tabName1" name="tab1"  v-if="$route.query.applySourceName=='false'">
...
@import "../../../../assets/css/viewer.css";
	.tabs .ivu-tabs-nav .ivu-tabs-tab:nth-child(2),.tabs .ivu-tabs-nav .ivu-tabs-tab:nth-child(3) {
