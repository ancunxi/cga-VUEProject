...
<template>
  <div class="layout-content">
    ...
    <Row>
      ...
      <Col span="24" class="center margin-bottom-20">
        <Button type="success" @click="printPage">打印</Button>
        <router-link :to="{path:'index', query:{moduleId:$route.query.moduleId, w04ID:$route.query.w04ID, caseId:$route.query.caseId, currentPage:$route.query.currentPage,pageSize:$route.query.pageSize,isCharge:$route.query.isCharge}}" style="margin-left:8px;">
          <Button>返回</Button>
        </router-link>
      </Col>
    </Row>          
