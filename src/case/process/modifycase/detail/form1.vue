...
-->          <!-- <iframe v-else class="sreportFramesCheck" width="100%" height="800" :src='this.fileReproUrls+"/ReportServer?reportlet="+cptUrl+"&op=write&__showtoolbar__=false&caseId="+this.caseIds'></iframe> -->
          <iframe  class="sreportFramesCheck" width="100%" height="800" style='border:none;' :src='fileReproUrls+"/ReportServer?reportlet="+cptUrl+"&op=write&__showtoolbar__=false&caseId="+caseIds'></iframe>
