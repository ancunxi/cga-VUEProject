<template>
  <div class="basicInfo">    
          ...
          <Row>
            ...
            <!-- <Col span="12">
              <FormItem label="办件流转街道：">
                <Select v-model="caseInfo.assignDeptId" placeholder="请选择办件流转街道">
                  <template v-for="item in assignDeptData">
                    <Option :value="item.deptId" :key="item.deptId">{{item.deptName}}</Option>
                  </template>
                </Select>
              </FormItem>
            </Col> -->  
          ...
          <Row>
            <Col span="8">
              <FormItem 
                ...
                <Input v-model="relatedPersonInfo.relatedPersonName" placeholder="请输入姓名"></Input>
              </FormItem>
            </Col>                   
            <Col span="8">
              <FormItem 
          ...
          <Row>
            <Col span="8">
              <FormItem 
                ...
                <Select v-model="relatedPersonInfo.cardType" placeholder="请选择企业类型">
    ...
    <Row v-if="isShowData.isRelatedperson === '0'" class="margin-bottom-20">
      ...
      <Col span="24">
        <Button type="primary"  @click="handleComplete0">保存</Button>
        <router-link :to="{path: '../index',query: {currentPage:this.$route.query.inCurrentPage}}"><Button>返回</Button></router-link>
      </Col>
    </Row> 
    <Modal
