    ...
    <Row>
      <template v-for="item in exampleDataList">
        <Col span="4" class="view">
          ...
          <a href="javascript:;" class="uploadArea" :title="item.fileName + item.fileType" style="padding-left:20%">
            ...
            <div class="uploadHoverBtn" style="margin-left:20%">
...
export default{
  ...
  methods:{
    exampleList(materialId, userCardNumber){
      this.checkboxModel = [];
      this.materialId = materialId;
      //查询申请人历史标准资料办件材料列表
      //cardNumber 证件号码或统一社会信用代码
      //materialId 事项资料ID
      axios.post("/cgaCaseMaterial/queryHistoryStandardMaterialFileList.do", {materialId:materialId,cardNumber:userCardNumber})
      .then(data=>{
