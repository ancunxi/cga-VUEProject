                ...
                <Col span="8">
                  ...
                  <Row v-if="uploadShow" class="uploadLocalFile">
                    <Col span="24">
                      ...
                      <form id="uploadFormSpecial" class="uploadForm" style="width:74px;height:32px;">
                        <input type="hidden" name="folder" :value="'cga/' + this.$route.query.caseId">
                        <input type="hidden" name="source" value="1">
                        <input type="file" name="datafile" class="file" @change="uploadSpecial" style="width:74px;height:32px;">
                      </form>         
                    </Col>
                  </Row>
                  <!--上传之后-->
