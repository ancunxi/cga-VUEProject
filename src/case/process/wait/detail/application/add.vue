...
export default{
  ...
  methods:{
    getAddList(materialId,relatedPersonCardNumber){
      this.checkboxModel = [];
      this.materialId = materialId;
      //查询申请人历史标准资料办件材料列表
      //cardNumber 证件号码或统一社会信用代码
      //materialId 事项资料ID
      axios.post("/cgaCaseMaterial/queryHistoryStandardMaterialFileList.do", {materialId:materialId,cardNumber:relatedPersonCardNumber})
      .then(data=>{
