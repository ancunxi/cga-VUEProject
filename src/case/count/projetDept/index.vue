<template>
	<div class="layout-content">
		...
		<div class="layout-list" style="left: 16.66666667%;right:0;padding-left:0;padding-right:0;margin-left:15px;">
	...
	export default {
					...
					this.endDate = datautil.formatDate(date2, 'yyyy-MM-dd');
				     ...
				     axios.post("/cgaSysLoginInfo/findInfoById.do")
				      .then(data => {
				      	  ...
				      	  var reportURL = this.cjkEncode(this.FineReportUrl + "/ReportServer?reportlet=/cga/caseProjectDeptStatistics.cpt&__pi__=false&__bypagesize__=false" +
       ...
       // location.reload();
			...
			exportPdf() {
				...
				var fileName = encodeURI("办件事项部门分类统计");
				var reportURL = this.cjkEncode(this.FineReportUrl+"/ReportServer?reportlet=/cga/caseProjectDeptStatistics.cpt&__pi__=false&__bypagesize__=false&format=pdf&__filename__=" +fileName+"&startDate=" + this.startDate + "&endDate=" + this.endDate + "&deptIds=" + this.allIdStr);
