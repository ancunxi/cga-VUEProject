    ...
    <Row v-if="this.projectData.applyObjectType=='0'" class="margin-bottom-20">
      <Col span="24">
        ...
        <Row>
          <Col span="8">
            <FormItem label="姓名：">
              {{this.userData.relatedPersonName}}<Icon type="person" v-if="this.userData.applyFileId!=undefined && this.userData.applyFileId!=''" title="点击查看头像" @click.native="viewIcon"></Icon>
            </FormItem>
          </Col>                   
          <Col span="8">
...
<script>
import mapModal from './mapSearch.vue';    //地图
